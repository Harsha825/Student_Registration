...
public class Registration extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(courseName, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(pNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void courseNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_courseNameActionPerformed
        ...
        private void table_update()
        {
            ...
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/arizona state university", "root","");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/arizona state university", "root","");
            insert = con1.prepareStatement("insert into record(name, phonenumber, course)values(?, ?, ?)");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        studentName.setText(dtm.getValueAt(selectedIndex, 1).toString());
        pNumber.setText(dtm.getValueAt(selectedIndex, 2).toString());
        courseName.setText(dtm.getValueAt(selectedIndex, 3).toString());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/arizona state university", "root","");
            insert = con1.prepareStatement("update record set name = ?, phonenumber = ?, course = ? where id = ? ");
            insert.setString(1, name);
            insert.setString(2, phonenumber);
            insert.setString(3, course);
            insert.setInt(4, id);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            int dialogue = JOptionPane.showConfirmDialog(null, "Do you want to delete this record?", "Warning",JOptionPane.YES_NO_OPTION);
